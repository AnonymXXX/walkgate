...
下载 [WalkGate-v0.3.4-macOS-Universal.dmg](https://github.com/AnonymXXX/walkgate/releases/download/v0.3.4/WalkGate-v0.3.4-macOS-Universal.dmg)，打开后将 `WalkGate.app` 拖入“应用程序”。该安装包同时支持 Apple Silicon 与 Intel Mac。
